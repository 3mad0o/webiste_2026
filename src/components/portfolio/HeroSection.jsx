...
import meImage from "../../assets/images/emad_jaber.jpeg";
const socialLinks = [
  { icon: Github, href: "https://github.com/3mad0o", label: "GitHub" },
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/emad-jaber-8bb072202/",
    label: "LinkedIn",
  },
  { icon: Mail, href: "mailto:emad.adel079@gmail.com", label: "Email" },
];
      ...
      <div className="container max-w-5xl mx-auto px-6">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            >
              Emad <span className="text-primary">Jaber</span>
            </motion.h1>
            ...
            >
              ...
              Strong in back-end development, clean responsive UIs, API
              integrations, and database-driven systems. Focused on code
              quality, performance, and delivering end-to-end solutions.
            </motion.p>
        ...
        <motion.div
          ...
          className="absolute md:bottom-10 sm:bottom-0 left-1/2 -translate-x-1/2"
        >
          <motion.div
            animate={{ y: [0, 8, 0] }}
